    ...
    <div className="font-sans text-gray-800 bg-white min-h-screen">
      ...
      <section className="py-20 bg-slate-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-tight" dir={currentDir}>
          ...
          <div className="flex justify-center mb-10 overflow-x-auto no-scrollbar pb-4">
            <div className="flex items-center gap-2 bg-white p-2 rounded-2xl border border-gray-200 shadow-sm">
              ...
              {languages.map(lang => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-sm font-bold whitespace-nowrap transition-all ${selectedLang === lang.code ? 'bg-[#6A0DAD] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'}`}
                >
                  {lang.name}
                </button>
              ))}
      ...
      <section className="py-16 bg-slate-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-gray-900 mb-4 tracking-tight">Participant <span className="text-[#6A0DAD]">Rights & Compliance</span></h2>
